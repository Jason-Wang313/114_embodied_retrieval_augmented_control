...
\usepackage{url}
\usepackage{booktabs}
\title{Embodied Retrieval-Augmented Control: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about retrieval-augmented robot policies. The original research bet was: Retrieve prior physical episodes by mechanism similarity, not language similarity. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Efficient Similarity-Based Datasheet Retrieval and Analysis Using Retrieval-Augmented Generation for Electronic Component Selection (2026)
\item Benchmarking retrieval-augmented large language models in biomedical NLP: Application, robustness, and self-awareness (2025)
\item Scalable Retrieval-Augmented Generation for Technical Documents with Hallucination Risk Control (2025)
\item Advancing Large Language Models with Enhanced Retrieval-Augmented Generation: Evidence from Biological UAV Swarm Control (2025)
\item PAI-NET: Retrieval-Augmented Generation Patent Network Using Prior Art Information (2025)
\end{itemize}
