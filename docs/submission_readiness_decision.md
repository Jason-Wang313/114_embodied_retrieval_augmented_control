...
Honest strongest claim: `Retrieve prior physical episodes by mechanism similarity, not language similarity.` is a plausible branch-structured mechanism for retrieval-augmented robot policies, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
