...
- [x] Paper-specific mechanism-retrieval control benchmark.
- [x] 5 contact-rich tasks.
- [x] 7 mechanism-shift regimes.
- [x] 5 corpus/domain splits.
...
- [ ] Released retrieval corpus and controller checkpoints.
