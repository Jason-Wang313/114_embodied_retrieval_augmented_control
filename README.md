...
This repository contains a hardened, honest workshop-only robotics paper draft for `embodied_retrieval_augmented_control`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/114.pdf`
